const PRESETS = [
  null,
  { level: 1, fillRate: 0.5, directRatio: 0.8, chainLength: [1, 2], rewindCoverage: 0.1, rewindDepth: 1, paradoxRatio: 0, crossLayerRatio: 0 },
  { level: 2, fillRate: 0.5, directRatio: 0.8, chainLength: [1, 2], rewindCoverage: 0.12, rewindDepth: 1, paradoxRatio: 0, crossLayerRatio: 0 },
  { level: 3, fillRate: 0.5, directRatio: 0.8, chainLength: [2, 3], rewindCoverage: 0.15, rewindDepth: 1, paradoxRatio: 0, crossLayerRatio: 0 },
  { level: 4, fillRate: 0.75, directRatio: 0.5, chainLength: [3, 4], rewindCoverage: 0.3, rewindDepth: 1, paradoxRatio: 0, crossLayerRatio: 0 },
  { level: 5, fillRate: 0.75, directRatio: 0.5, chainLength: [3, 5], rewindCoverage: 0.34, rewindDepth: 1, paradoxRatio: 0.05, crossLayerRatio: 0 },
  { level: 6, fillRate: 0.75, directRatio: 0.5, chainLength: [4, 5], rewindCoverage: 0.38, rewindDepth: 2, paradoxRatio: 0.05, crossLayerRatio: 0 },
...
class Difficulty {
  ...
  static getConfig(level = 1) {
    ...
    return Object.assign({}, PRESETS[clamped] || PRESETS[10]);
  }
